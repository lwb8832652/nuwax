...
export const EN_US: SystemLangMap = {
  "PC.Pages.Chat.switchExpertConfirmation": "Selecting {0} starts a new conversation. Your current conversation will be kept.",
  "PC.Pages.Chat.switchModeDraftHint": "Send or clear your draft before switching modes",
  "PC.Pages.Chat.switchModeBusyHint": "Wait for the current response before switching modes",
  "PC.Pages.Chat.switchModePendingHint": "Switching conversations",
  "PC.Components.ChatInputHomeAtMentionIcon.tryMentionResource": "Select resources",
  "PC.Components.ChatInputHome.workbenchAsk": "Ask",
  "PC.Components.ChatInputHome.workbenchAgent": "Agent",
  "PC.Components.ChatInputHome.selectWorkMode": "Select work mode",
  "PC.Components.ChatInputHome.summonExpert": "Summon expert",
  "PC.Components.ChatInputHome.noExperts": "No experts available",
  "PC.Components.ChatInputHomeMentionEditor.removeResourceMention": "Remove resource mention",
  "PC.Components.ChatInputHomeMentionEditor.placeholderWithResourceMention": "Describe your task, or type @ to select resources",
  "PC.Components.ChatInputHomeMentionPopup.selectResourceType": "Select resource type",
  "PC.Components.ChatInputHomeMentionPopup.currentSessionResource": "Resources for this conversation",
  "PC.Components.ChatInputHomeMentionPopup.noAvailableResource": "This expert has no resources available for manual selection",
  "PC.Components.ChatInputHomeMentionPopup.searchResource": "Search resources",
  "PC.Components.ChatInputHomeMentionPopup.alreadyEnabled": "Enabled",
  "PC.Components.ChatInputHomeMentionPopup.backToResourceTypes": "Back to resource types",
  "PC.Pages.IMChannel.Index.searchExpertPlaceholder": "Search expert name",
  "PC.Pages.Setting.title": "Settings",
  "PC.Components.NewxCreateExpert.createSuccess": "expert created successfully",
  "PC.Components.NewxCreateExpert.createTitle": "Create",
  "PC.Components.NewxCreateExpert.descriptionLabel": "expert Description",
  "PC.Components.NewxCreateExpert.descriptionPlaceholder": "Describe the expert's features, which will be shown to the expert's users",
  "PC.Components.NewxCreateExpert.editSuccess": "expert edited successfully",
  "PC.Components.NewxCreateExpert.nameLabel": "expert Name",
  "PC.Components.NewxCreateExpert.namePlaceholder": "Give the expert a unique name",
  "PC.Components.NewxCreateExpert.nameRequired": "Please enter the expert name",
  "PC.Components.NewxCreateExpert.updateTitle": "Update expert",
  "PC.Pages.NewxHomeDrag.agent": "expert",
  "PC.Pages.NewxHomeDrag.agentAvatar": "expert avatar",
  "PC.Pages.NewxHomeDrag.agentName": "expert name",
  "PC.Pages.NewxHomeDrag.dragAgentTip": "Drag expert cards to swap positions",
  "PC.Pages.NewxHomeDrag.unnamedAgent": "Unnamed expert",
  "PC.Pages.Setting.myComputer": "My computers",
  "PC.Pages.Setting.apiKeys": "API keys",
  "PC.Pages.Setting.imBots": "IM bots",
  "PC.Pages.Setting.moreSettings": "More",
  "PC.Pages.Setting.selectSpace": "Select a workspace",
  "PC.Pages.Setting.noAvailableSpace": "No workspace available",
  "PC.Components.ResourceCatalog.mine": "My",
  "PC.Components.ResourceCatalog.inSpace": "Team",
  "PC.Components.ResourceCatalog.discover": "Marketplace",
  "PC.Components.ResourceCatalog.resources": "Resources",
  "PC.Components.ResourceCatalog.templates": "Templates",
  "PC.Pages.Home.discoverExperts": "Discover experts",
  "PC.Components.Newx.expert": "Expert",
  "PC.Components.Newx.experts": "Experts",
  "PC.Components.Newx.skills": "Skills",
  "PC.Components.Newx.connectors": "Connectors",
  "PC.Components.Newx.createExpert": "Create expert",
  "PC.Components.Newx.searchExperts": "Search experts",
  "PC.Components.Newx.expertOverview": "Expert overview",
  "PC.Components.Newx.createConnector": "Create connector",
  "PC.Components.Newx.searchConnectors": "Search connectors",
  "PC.Components.Newx.emptyExplore": "Discover experts to get started",
  "PC.Common.Global.close": "Close",
  "PC.Pages.Home.workbench": "Workbench",
  "PC.Pages.Home.welcome": "What can I help you with?",
  "PC.Pages.Home.recentWork": "Recent work",
  "PC.Pages.Home.viewAll": "View all",
  "PC.Pages.SpaceCreateProject.createTitle": "Create a project",
  "PC.Pages.SpaceCreateProject.createDescription": "Choose what to build and describe your idea. Let AI help you bring it to life.",
  ...
  "PC.Pages.IMChannel.CardList.qqConnectFailed": "Operation failed, please try again later",
  "PC.Pages.IMChannel.CardList.qqConnectSuccess": "Connection started",
  "PC.Pages.IMChannel.CardList.qqConnection": "Connect",
  "PC.Pages.IMChannel.CardList.qqDisconnectSuccess": "Connection stopped",
  "PC.Pages.IMChannel.CardList.qqStatusConnected": "Connected",
  "PC.Pages.IMChannel.CardList.qqStatusConnecting": "Connecting",
  "PC.Pages.IMChannel.CardList.qqStatusDisconnected": "Disconnected",
  "PC.Pages.IMChannel.CardList.qqStatusNoConfig": "Not configured",
  "PC.Pages.IMChannel.CardList.qqStatusReconnecting": "Reconnecting",
  ...
  "PC.Pages.Login.brandSlogan": "YOUR AI WORKBENCH",
  "PC.Pages.Login.featureOfficeTitle": "Office Productivity",
  "PC.Pages.Login.featureOfficeSub": "Docs · Slides · Data",
  "PC.Pages.Login.featureDevTitle": "Dev Collaboration",
  "PC.Pages.Login.featureDevSub": "Code · Debug · Tasks",
  "PC.Pages.Login.trait1Title": "Resources as a Service",
  "PC.Pages.Login.trait1Desc": "Experts, skills & connectors on demand",
  "PC.Pages.Login.trait2Title": "Built for Teams",
  "PC.Pages.Login.trait2Desc": "Reusable workflows in shared spaces",
  "PC.Pages.Login.trait3Title": "Execute with Confidence",
  "PC.Pages.Login.trait3Desc": "Clear task progress & artifacts",
  "PC.Pages.Login.leftQuote": "From idea to delivery, every step is traceable in {0}.",
  "PC.Pages.Login.welcomeBadge": "WELCOME TO NEWX",
  "PC.Pages.Login.welcomeTitle": "Welcome back",
  "PC.Pages.Login.welcomeSubPassword": "Sign in with your phone number and password.",
  "PC.Pages.Login.welcomeSubCode": "We'll send a verification code to your phone.",
  "PC.Pages.Login.phoneLabel": "Phone",
  "PC.Pages.Login.emailLabel": "Email",
  "PC.Pages.Login.passwordLabel": "Password",
  "PC.Pages.Login.needHelp": "Need help?",
  "PC.Pages.Login.contactSupport": "Contact support",
